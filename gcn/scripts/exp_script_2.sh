...
DGLBACKEND=mxnet python /homes/cx2/gcn/dgl-gcn/gcn/gcn_edge_origin.py --save $modelfile --dataset "cora" --lr 0.01 --n-epochs 200 --n-layers 2 --n-hidden 64 --dropout 0.5 --normalization 'left' 2>&1 | tee $watchfile
