...
DGLBACKEND=mxnet python /homes/cx2/gcn/dgl-gcn/gcn/gcn_edge_origin.py --save $modelfile --dataset "cora" --lr 0.002 --n-epochs 200 --n-layers 1 --n-hidden 64 --dropout 0.5 --normalization 'left' --self-loop 2>&1 | tee $watchfile
